...
# go to schemas select tables and upload csv! once loaded start using it! 
...
#5. Get the details  of rides cancelled by drivers due to personal and car-related issues:
